...
function ItemTopic(props) {
    ...
    return (
        ...
        >
            <Button className='hover_grammar' style={{ height: '110px', borderRadius: '20px', marginBottom: '20px', width: '100%', boxShadow: 'rgb(0 0 0 / 15%) 0px 4px 32px', justifyContent: 'space-between' }}>
